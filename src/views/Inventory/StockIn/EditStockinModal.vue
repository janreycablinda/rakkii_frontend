...
export default {
    ...
    watch: {
        editModalData(newData){
            ...
            this.form.total_cost = newData.data.total_cost;
            this.form.date = new Date(newData.data.date);
            this.form.id = newData.data.id;

            let params = [];
            newData.data.stockin_temps.forEach(item => {
            ...
            this.$store.commit('stockin/SET_STOCKIN_TEMP', params);
        },
        date(){
            ...
            if (this.isValid) {
                ...
                if(this.stockin_temp != ''){
                    ...
                    const params = {
                     ...
                     this.$store.dispatch('stockin/updateStockin', params).then(() => {
